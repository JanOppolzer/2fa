...
The easiest way to install 2FA is to use Laravel [Envoy](https://laravel.com/docs/10.x/envoy) script that is included in this repository.
...
```bash
git clone https://github.com/JanOppolzer/2fa
```
