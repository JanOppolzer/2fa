...
return [
    ...
    'howto' => 'To enable 2FA for you account, go to <a class="hover:underline text-blue-500" href="/profile">your profile</a>.',
    'introduction' => 'Welcome to <em>2FA</em> application (short for 2 Factor Authentication), a web application to manage "second factor" for CESNET\'s Identity Provider.',
    'mail' => 'email address',
